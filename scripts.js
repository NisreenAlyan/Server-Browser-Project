...
latest_ver = latest_ver.replace(".", "");
version_no = version_no.replace(".", "");
version_no = version_no.replace(".", "");
if(version_no >= latest_ver){
alert('You are running the latest version (v. ' + version + ').');
}
else
{
parent.main.location="http://simple.webventures.com.au/browser/update/"; 
}
}
function homein()
{
parent.main.location="home.html"; 
}
function readme()
{
parent.main.location="readme.html"; 
}
function source()
{
frames['main'].location.href="view-source:" + frames['main'].location.href;
}
function parseForm(my){
	var f = my.form;
	var s = f.url.value;
}
...
{
txt="Simple Browser has encountered an error.\n\n";
txt+="Error: " + msg + "\n";
txt+="URL: " + url + "\n";
txt+="Line: " + l + "\n\n";
...
animatedcollapse.addDiv('licence', 'fade=1')
animatedcollapse.addDiv('ins', 'fade=1')
animatedcollapse.addDiv('inter', 'fade=1')
animatedcollapse.addDiv('errors', 'fade=1')
animatedcollapse.addDiv('support', 'fade=1')
animatedcollapse.addDiv('unins', 'fade=1')
animatedcollapse.addDiv('sys', 'fade=1')
animatedcollapse.addDiv('funds', 'fade=1')
